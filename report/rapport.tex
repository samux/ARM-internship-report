	...
	\item When a message is received:
		\begin{packed_item}
			...
			\begin{packed_item}
				\item ignore it
			\end{packed_item}
			\item if the message comes from a board:
					\begin{packed_item}
...
\begin{packed_item}
	...
	\item When a message is received:
		\begin{packed_item}
			...
			\item if the message comes from a board:
			\begin{packed_item} 
				\item if the board has been previously added, refresh a specific graph according to the \textbf{id field} contained in the message
			\end{packed_item}
		\end{packed_item}
\end{packed_item}
\end{minipage} 
...
\begin{packed_item}
	...
	\item \textbf{USB device layer}: Extension of the USB class layer in order to distinguish several different devices of the same class
